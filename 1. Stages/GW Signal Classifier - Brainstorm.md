...
- [ ] **Stage 3 — hard negatives. ▶️ NEXT** Add Gravity Spy glitches as a negative class. Now report false-alarm rate. This is where the CNN has a genuine shot at beating MF *in practice*, because glitches are exactly what break MF's assumptions — and [[Stage 2]] just showed the CNN learns glitch-vs-chirp implicitly from ~28 glitches/h of unlabelled exposure.
